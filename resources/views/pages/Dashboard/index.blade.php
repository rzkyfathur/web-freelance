                    ...
                    <div @click.away="open = false" class="relative z-10 hidden mt-5 lg:block" x-data="{ open: false }">
                        <button class="flex flex-row items-center w-full px-4 py-2 mt-2 text-left bg-white rounded-lg dark-mode:bg-transparent dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:focus:bg-gray-600 dark-mode:hover:bg-gray-600 md:w-auto md:inline md:mt-0 md:ml-4">
                            @if (auth()->user()->detail_user()->first()->photo)
                                <img class="inline w-12 h-12 mr-3 rounded-full" src="{{ url(Storage::url(auth()->user()->detail_user()->first()->photo))}}" alt="">
                            @else
                            ...
                            <tbody class="bg-white">
                                ...
                                @forelse ($orders as $key => $item)
                                    <tr class="text-gray-700">
                                            ...
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    @if ($item->user_buyer->detail_user->photo != null)
                                                        <img class="object-cover w-full h-full rounded-full" src="{{url(Storage::url($item->user_buyer->detail_user->photo))}}" alt="Photo profile" loading="lazy" />
                                                    @else
                                                ...
                                                <div>
                                                    ...
                                                    @if ($item->order_status_id === '1')
                                                        ...
                                                        <p class="text-sm text-yellow-400">{{$item->order_status->name ?? ''}}</p>
                                        ...
                                        <td class="px-1 py-5 text-xs text-red-500 items-center">
