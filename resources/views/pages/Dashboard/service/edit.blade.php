                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        @forelse ($advantage_service as $advantage_item)
                                            <input placeholder="Keunggulan Service" type="text" name="{{ ('advantage_services['.$advantage_item->id.']') }}" id="advantage_services" autocomplete="advantage_services" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $advantage_item->advantage ?? '' }}" required>
                                        @empty
                                            {{-- empty --}}
                                        @endforelse
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        @forelse ($advantage_user as $advantage_user_item)
                                            <input placeholder="Keunggulan Kamu" type="text" name="{{ ('advantage_users['.$advantage_user_item->id.']') }}" id="advantage_users" autocomplete="advantage_users" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $advantage_user_item->advantage ?? '' }}" required>
                                        @empty
                                            {{-- empty --}}
                                        @endforelse
