                                ...
                                <tbody class="bg-white">
                                    @forelse ($services as $key => $service)
                                        <tr class="text-gray-700 border-b">
                                            <td class="w-full px-1 py-5 flex items-center">
                                                <div class="flex items-center text-sm">
                                                    @if (isset($service->thumbnail_service[0]->thumbnail) != null)
                                                        <img class="object-cover w-20 h-full rounded" src="{{ url(Storage::url($service->thumbnail_service[0]->thumbnail)) }}" alt="thumbnail" loading="lazy" />
                                                    @else
                                                ...
                                                <div>
                                                        <a href="{{ '#' }}" class="font-medium text-black ml-4">
                                                            {{ $service->title ?? '' }}
                                                        </a>
                                                    </div>
                                            </td>
